# `@f1stnpm2/earum-vel-in` <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```sh
npm install eslint @f1stnpm2/earum-vel-in --save-dev
```
...
If you are using the [new JSX transform from React 17](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html#removing-unused-react-imports), extend [`react/jsx-runtime`](https://github.com/f1stnpm2/earum-vel-in/blob/c8917b0885094b5e4cc2a6f613f7fb6f16fe932e/index.js#L163-L176) in your eslint config (add `"plugin:react/jsx-runtime"` to `"extends"`) to disable the relevant rules.
...
**Note**: These configurations will import `@f1stnpm2/earum-vel-in` and enable JSX in [parser options](https://eslint.org/docs/user-guide/configuring/language-options#specifying-parser-options).
...
The default export of `@f1stnpm2/earum-vel-in` is a plugin object.

```js
const react = require('@f1stnpm2/earum-vel-in');
...
- `@f1stnpm2/earum-vel-in/configs/all`
- `@f1stnpm2/earum-vel-in/configs/recommended`
- `@f1stnpm2/earum-vel-in/configs/jsx-runtime`

If your eslint.config.js is ESM, include the `.js` extension (e.g. `@f1stnpm2/earum-vel-in/recommended.js`). Note that the next semver-major will require omitting the extension for these imports.

**Note**: These configurations will import `@f1stnpm2/earum-vel-in` and enable JSX in [`languageOptions.parserOptions`](https://eslint.org/docs/latest/user-guide/configuring/configuration-files-new#configuration-objects).
...
```js
const reactRecommended = require('@f1stnpm2/earum-vel-in/configs/recommended');
...
💼 [Configurations](https://github.com/f1stnpm2/earum-vel-in/#shareable-configs) enabled in.\
🚫 [Configurations](https://github.com/f1stnpm2/earum-vel-in/#shareable-configs) disabled in.\
🏃 Set in the `jsx-runtime` [configuration](https://github.com/f1stnpm2/earum-vel-in/#shareable-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/f1stnpm2/earum-vel-in/#shareable-configs).\
...
- Rules of Hooks: [@f1stnpm2/earum-vel-in-hooks](https://github.com/facebook/react/tree/master/packages/@f1stnpm2/earum-vel-in-hooks)
- JSX accessibility: [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)
- React Native: [@f1stnpm2/earum-vel-in-native](https://github.com/Intellicode/@f1stnpm2/earum-vel-in-native)

## License

`@f1stnpm2/earum-vel-in` is licensed under the [MIT License](https://opensource.org/licenses/mit-license.php).

[npm-url]: https://npmjs.org/package/@f1stnpm2/earum-vel-in
[npm-image]: https://img.shields.io/npm/v/@f1stnpm2/earum-vel-in.svg

[status-url]: https://github.com/f1stnpm2/earum-vel-in/pulse
[status-image]: https://img.shields.io/github/last-commit/jsx-eslint/@f1stnpm2/earum-vel-in.svg

[tidelift-url]: https://tidelift.com/subscription/pkg/npm-@f1stnpm2/earum-vel-in?utm_source=npm-@f1stnpm2/earum-vel-in&utm_medium=referral&utm_campaign=readme
[tidelift-image]: https://tidelift.com/badges/package/npm/@f1stnpm2/earum-vel-in?style=flat

[package-url]: https://npmjs.org/package/@f1stnpm2/earum-vel-in
[npm-version-svg]: https://versionbadg.es/jsx-eslint/@f1stnpm2/earum-vel-in.svg

[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/jsx-eslint/@f1stnpm2/earum-vel-in
[actions-url]: https://github.com/f1stnpm2/earum-vel-in/actions
